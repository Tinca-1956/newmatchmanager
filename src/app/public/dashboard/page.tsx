        ...
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div className="flex-grow">
            ...
            <p className="text-muted-foreground">
              Welcome to Match Manager. Select a club to see what&apos;s happening.
            </p>
          </div>
          <div className="flex items-center gap-4">
             <div className="flex flex-col gap-1.5">
                ...
                >
                  <SelectTrigger id="club-filter" className="w-[200px] bg-background">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <Card>
              ...
              <CardContent>
                  <Table>
                      ...
                      <TableBody>
                          {selectedClubId ? renderUpcomingMatches() : <TableRow><TableCell colSpan={4} className="h-24 text-center text-muted-foreground">Please select a club to view matches.</TableCell></TableRow>}
                      </TableBody>
                  </Table>
              </CardContent>
            </Card>
          ...
          <Card className="flex flex-col">
              <CardHeader>
                  ...
                  {isLoadingResults && selectedClubId ? (
                      <Skeleton className="h-5 w-48" />
                  ) : (
                      <CardDescription>{selectedClubId && recentResults.length > 0 ? recentResultsTitle : "No completed matches"}</CardDescription>
                  )}
              </CardHeader>
              <CardContent className="flex-grow">
                  <Table>
                      ...
                      <TableBody>
                          {selectedClubId ? renderRecentResults() : <TableRow><TableCell colSpan={4} className="h-24 text-center text-muted-foreground">Please select a club to view results.</TableCell></TableRow>}
                      </TableBody>
                  </Table>
              </CardContent>
              {selectedClubId && recentMatchId && (
                  <CardFooter>
          ...
          <Card className="flex flex-col">
              <CardHeader>
                  ...
                  {isLoadingResults && selectedClubId ? (
                      ...
                      <CardDescription>{selectedClubId && recentMatchImages.length > 0 ? "From the last match" : "No recent photos"}</CardDescription>
                  )}
              </CardHeader>
              <CardContent className="flex-grow flex items-center justify-center">
                  {selectedClubId ? renderImageGallery() : 
                    <div className="flex flex-col items-center justify-center h-full min-h-[200px] text-center p-4 border border-dashed rounded-lg bg-muted/50">
                        <ImageIcon className="h-12 w-12 text-muted-foreground" />
      ...
      <AlertDialog open={isModalOpen} onOpenChange={setIsModalOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Please sign in to view match details and register for events.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            <AlertDialogCancel>Close</AlertDialogCancel>
            <AlertDialogAction onClick={handleGoToSignIn}>
              Go to Sign In
            </AlertDialogAction>
          </AlertDialogFooter>
        </AlertDialogContent>
...
export default function PublicDashboardPageSuspense() {
    return (
